...
$route['api/admin/programs']['post'] = 'api/AdminController/programs_post';
$route['api/admin/programs/(:num)']['put'] = 'api/AdminController/programs_put/$1';
$route['api/admin/programs/(:num)/archive']['post'] = 'api/AdminController/programs_archive_post/$1';
$route['api/admin/programs/(:num)/restore']['post'] = 'api/AdminController/programs_restore_post/$1';
...
$route['api/admin/academic-year-management/(:num)']['get'] = 'api/AcademicYearController/show_get/$1';
$route['api/admin/academic-year-management/(:num)/activate']['post'] = 'api/AcademicYearController/activate_post/$1';
$route['api/admin/academic-year-management/(:num)/close']['post'] = 'api/AcademicYearController/close_post/$1';
$route['api/admin/academic-year-management/(:num)/promotion']['get'] = 'api/AcademicYearController/promotion_get/$1';
$route['api/admin/academic-year-management/(:num)/promotion/finalize']['post'] = 'api/AcademicYearController/promotion_finalize_post/$1';
$route['api/admin/academic-year-management/(:num)/promotion/students/(:any)']['patch'] = 'api/AcademicYearController/promotion_student_patch/$1/$2';
$route['api/admin/academic-year-management/year-levels']['get'] = 'api/AcademicYearController/year_levels_get';
$route['api/admin/academic-year-management/year-levels']['post'] = 'api/AcademicYearController/year_levels_post';
$route['api/admin/academic-year-management/year-levels/(:num)/archive']['post'] = 'api/AcademicYearController/year_level_archive_post/$1';
$route['api/admin/academic-year-management/year-levels/(:num)/restore']['post'] = 'api/AcademicYearController/year_level_unarchive_post/$1';
$route['api/admin/academic-year-management/sections']['get'] = 'api/AcademicYearController/sections_management_get';
$route['api/admin/academic-year-management/sections/(:num)/archive']['post'] = 'api/AcademicYearController/section_archive_post/$1';
$route['api/admin/academic-year-management/sections/(:num)/restore']['post'] = 'api/AcademicYearController/section_unarchive_post/$1';
...
$route['api/admin/students/bulk-upload']['post'] = 'api/AdminController/students_bulk_upload_post';
$route['api/admin/students/check-duplicates']['post'] = 'api/AdminController/students_check_duplicates_post';
$route['api/admin/students/check-duplicate-emails']['post'] = 'api/AdminController/students_check_duplicate_emails_post';
$route['api/admin/students/validate-bulk-upload']['post'] = 'api/AdminController/students_validate_bulk_upload_post';
...
$route['api/student/join-requests']['post'] = 'api/StudentController/join_requests_post';
...
$route['api/tasks/(:num)/manual-grade']['post'] = 'api/TaskController/manual_grade_post/$1';
$route['api/tasks/files/(:any)']['get'] = 'api/TaskController/serve_file/$1';
$route['api/tasks/attachments/(:any)']['get'] = 'api/TaskController/serve_task_attachment/$1';
...
$route['api/notifications/test-email/(:any)']['get'] = 'api/Notifications_api/test_email/$1';
...
$route['api/notifications/test-sse']['get'] = 'api/Notifications/test_sse';
$route['api/notifications/sse-test']['get'] = 'api/Notifications/sse_test';
...
$route['api/notifications/test-sse/(:any)']['get'] = 'api/Notifications/test_sse/$1';
