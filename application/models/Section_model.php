...
class Section_model extends CI_Model {
    ...
    private function get_enrolled_count_expression()
    {
        ...
        $historyExpr = '(SELECT COUNT(*) FROM section_student_history h WHERE h.section_id = sections.section_id AND (BINARY h.academic_year_name = BINARY sections.academic_year OR (h.academic_year_id IS NOT NULL AND sections.academic_year_id IS NOT NULL AND h.academic_year_id = sections.academic_year_id)) AND (h.semester IS NULL OR BINARY h.semester = BINARY sections.semester))';
