...
define('GOOGLE_CLIENT_ID', '915997325303-6h2v8ctgegd6d6ft51vdmf4o1ir1lmah.apps.googleusercontent.com');
define('GOOGLE_CLIENT_SECRET', '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');

// JWT Configuration
define('JWT_SECRET_KEY', 'scms-jwt-secret-key-2024-change-in-production');
